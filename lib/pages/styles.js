const BASE_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  .btn-primary { background: var(--accent); color: #fff; box-shadow: 0 8px 20px -6px rgba(226,87,43,.55); }
  .btn-primary:hover { background: #cc4a20; }
  ...
  .pill {
    ...
    font-weight: 600; letter-spacing: .02em; background: var(--accent-soft); color: #9a3316;
  }
  .card {
