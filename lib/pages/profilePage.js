...
function renderProfilePage({ profileJson, docs = {} }) {
...
${BASE_CSS}
  ...
  .doc-row { display: flex; align-items: center; justify-content: space-between; padding: 14px 0; border-bottom: 1px solid var(--border); }
