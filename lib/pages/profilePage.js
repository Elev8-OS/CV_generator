...
function renderProfilePage({ profileJson, media = {}, libraryDocs = [], libraryCategories = [], username = "" }) {
  ...
  const mediaRow = (key, label, hint) => {
    ...
    return `
      <div class="doc-row">
        ...
        <div class="doc-actions">
          ${m.available ? `<a class="btn btn-outline" href="/api/media/mine/${key}" target="_blank">Ansehen</a>` : ""}
