...
<style>
${baseCss(accentColor)}
  header.top { background: var(--ink); color: #fff; padding: 18px 0; }
  header.top .container { display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 14px; }
  header.top h1 { font-size: 17px; margin: 0; font-weight: 700; white-space: nowrap; }
  header.top a.navlink { font-size: 13.5px; color: #cfd3da; text-decoration: none; }
  .header-left { display: flex; align-items: center; gap: 14px; }
  .header-divider { width: 1px; height: 24px; background: rgba(255,255,255,.16); flex: none; }
  .header-avatar {
  ...
  .header-name { font-size: 14.5px; font-weight: 700; color: #fff; white-space: nowrap; }
  ...
  .panels-2col > .card + .card { margin-top: 0; }
...
<body>
  ...
  <main class="container">
    ...
    <p class="subtitle" style="margin:22px 0 24px;">${esc(t(l, "profile.headerTagline"))}</p>
