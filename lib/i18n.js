...
const DICT = {
  ...
  cvImport: {
    ...
    // {{seconds}} is filled in server-side (lib/timings.js averageSeconds)
    // with the rolling average of recent real requests, not a fixed guess —
    // see lib/pages/cvImportPage.js.
    statusAnalyzing: {
      de: "Analysiere CV … (dauert im Schnitt {{seconds}} Sekunden)",
      fr: "Analyse du CV … (dure en moyenne {{seconds}} secondes)",
      en: "Analyzing CV … (takes {{seconds}} seconds on average)"
    },
  ...
  profile: {
    ...
    signatureHint: {
      de: "Foto/Scan auf hellem Grund — wird im Motivationsschreiben und auf dem RAV-Nachweis verwendet",
      fr: "Photo/scan sur fond clair — utilisée dans la lettre de motivation et sur l'attestation ORP",
      en: "Photo/scan on a light background — used in the cover letter and on the RAV proof-of-effort form"
    },
    ...
    fieldAhv: { de: "AHV-Nr.", fr: "N° AVS", en: "Social security no." },
    fieldAhvHint: {
      de: "Format 756.xxxx.xxxx.xx — nur für den RAV-Nachweis (siehe unten) benötigt.",
      fr: "Format 756.xxxx.xxxx.xx — nécessaire uniquement pour l'attestation ORP (voir ci-dessous).",
      en: "Format 756.xxxx.xxxx.xx — only needed for the RAV proof-of-effort form (see below)."
    },
    ravAdvisorTitle: { de: "RAV-Berater:in", fr: "Conseiller/ère ORP", en: "RAV advisor" },
    ravAdvisorSubtitle: {
      de: "Wird nicht auf dem Formular abgedruckt — nur verwendet, um den monatlichen Nachweis im Dashboard direkt per Mail an deine/n Berater:in vorzubereiten.",
      fr: "N'apparaît pas sur le formulaire — sert uniquement à préparer l'envoi mensuel de l'attestation par e-mail à ton/ta conseiller/ère depuis le tableau de bord.",
      en: "Not printed on the form itself — only used to prepare the monthly proof-of-effort email to your advisor from the dashboard."
    },
    fieldRavAdvisorName: { de: "Name Berater:in", fr: "Nom du/de la conseiller/ère", en: "Advisor's name" },
    fieldRavAdvisorEmail: { de: "E-Mail Berater:in", fr: "E-mail du/de la conseiller/ère", en: "Advisor's email" },
    fieldRavAdvisorPhone: { de: "Telefon (optional)", fr: "Téléphone (facultatif)", en: "Phone (optional)" },
    fieldRavOffice: { de: "RAV-Stelle / Standort (optional)", fr: "Office ORP / lieu (facultatif)", en: "RAV office / location (optional)" },
  ...
  // Arbeitsbemühungen", form 716.007 — see lib/pdf/rav.js). This namespace
  // covers only this TOOL'S OWN dashboard UI around the feature (section
  // title, the per-application edit panel, the month picker); the generated
  // PDF itself is always German, regardless of dashboard language — see
  // lib/pdf/rav.js for why.
  rav: {
    sectionTitle: {
      de: "Nachweis der Arbeitsbemühungen (RAV)",
      fr: "Preuve des recherches d'emploi (ORP)",
      en: "Proof of job-search efforts (RAV/unemployment office)"
    },
    sectionSubtitle: {
      de: "Erstellt automatisch das monatliche RAV-Formular 716.007, ausgefüllt mit deinen Bewerbungen aus dem gewählten Monat.",
      fr: "Génère automatiquement le formulaire mensuel ORP 716.007, rempli avec tes candidatures du mois sélectionné.",
      en: "Automatically generates the monthly RAV form 716.007, filled in with your applications from the selected month."
    },
    monthLabel: { de: "Monat", fr: "Mois", en: "Month" },
    downloadBtn: { de: "PDF herunterladen", fr: "Télécharger le PDF", en: "Download PDF" },
    ahvMissingHint: {
      de: "Hinweis: Deine AHV-Nr. ist noch nicht hinterlegt — im Profil-Tab \"Profil\" ergänzen.",
      fr: "Remarque : ton n° AVS n'est pas encore renseigné — à compléter dans l'onglet \"Profil\".",
      en: "Note: your social security number isn't set yet — add it on the \"Profile\" tab."
    },
    editBtn: { de: "RAV-Angaben", fr: "Indications ORP", en: "RAV details" },
    closeBtn: { de: "Schliessen", fr: "Fermer", en: "Close" },
    fieldRavAssignment: { de: "Zuweisung durch RAV", fr: "Attribution par l'ORP", en: "Assigned by the RAV office" },
    fieldPensum: { de: "Pensum", fr: "Taux d'activité", en: "Workload" },
    optionVollzeit: { de: "Vollzeit", fr: "Plein temps", en: "Full-time" },
    optionTeilzeit: { de: "Teilzeit", fr: "Temps partiel", en: "Part-time" },
    pensumPercentPlaceholder: { de: "%", fr: "%", en: "%" },
    fieldBewerbungsart: { de: "Bewerbungsart", fr: "Type de candidature", en: "Application method" },
    optionBrieflich: { de: "Brieflich / elektronisch", fr: "Par courrier / électronique", en: "By mail / electronic" },
    optionPersoenlich: { de: "Persönlich", fr: "En personne", en: "In person" },
    optionTelefonisch: { de: "Telefonisch", fr: "Par téléphone", en: "By phone" },
    fieldCompanyAddress: { de: "Firmenadresse", fr: "Adresse de l'entreprise", en: "Company address" },
    fieldContactPhone: { de: "Kontaktperson, Telefon-Nr.", fr: "Personne de contact, n° de téléphone", en: "Contact person, phone no." },
    fieldAbsagegrund: { de: "Absagegrund (falls Absage)", fr: "Motif du refus (si refus)", en: "Rejection reason (if rejected)" },
    saveOk: { de: "Gespeichert ✓", fr: "Enregistré ✓", en: "Saved ✓" },
    saveError: { de: "Konnte nicht gespeichert werden.", fr: "Impossible d'enregistrer.", en: "Could not be saved." },
    sendToAdvisorBtn: { de: "An Berater:in senden", fr: "Envoyer au/à la conseiller/ère", en: "Send to advisor" },
    advisorMissingHint: {
      de: "Hinweis: Noch keine RAV-Berater:in hinterlegt — im Profil-Tab \"Profil\" ergänzen, um das Formular direkt vorzubereiten.",
      fr: "Remarque : aucun·e conseiller·ère ORP n'est encore renseigné·e — à compléter dans l'onglet \"Profil\" pour préparer l'envoi direct du formulaire.",
      en: "Note: no RAV advisor set yet — add one on the \"Profile\" tab to prepare the form for direct sending."
    },
    sendToAdvisorHint: {
      de: "Öffnet zugleich den PDF-Download — die Mail kommt vorbereitet, das PDF muss noch manuell angehängt werden (E-Mails können keine automatischen Anhänge aus dem Browser bekommen).",
      fr: "Ouvre aussi le téléchargement du PDF — l'e-mail est prêt, il faut encore joindre le PDF manuellement (le navigateur ne peut pas joindre de fichier automatiquement à un e-mail).",
      en: "Also opens the PDF download — the email comes pre-filled, the PDF still needs to be attached manually (browsers can't auto-attach files to an email)."
    },
    // Placeholders %MONTH%/%NAME%/%FILENAME% are substituted client-side
    // (public/app.js) — %NAME% is the account owner's own name (the
    // sender/signatory), not the advisor's.
    mailtoSubjectTemplate: {
      de: "Nachweis der Arbeitsbemühungen – %MONTH% – %NAME%",
      fr: "Preuve des recherches d'emploi – %MONTH% – %NAME%",
      en: "Proof of job-search efforts – %MONTH% – %NAME%"
    },
    mailtoGreetingWithName: { de: "Guten Tag %NAME%,", fr: "Bonjour %NAME%,", en: "Dear %NAME%," },
    mailtoGreetingGeneric: { de: "Guten Tag,", fr: "Bonjour,", en: "Hello," },
    mailtoBodyTemplate: {
      de: "Anbei der Nachweis meiner persönlichen Arbeitsbemühungen für %MONTH%.\n\nHinweis: Diese E-Mail wurde automatisch vorbereitet — das PDF (%FILENAME%) wurde bereits heruntergeladen und muss noch manuell angehängt werden.",
      fr: "Veuillez trouver ci-joint la preuve de mes recherches d'emploi personnelles pour %MONTH%.\n\nRemarque : cet e-mail a été préparé automatiquement — le PDF (%FILENAME%) a déjà été téléchargé et doit encore être joint manuellement.",
      en: "Please find attached the proof of my personal job-search efforts for %MONTH%.\n\nNote: this email was prepared automatically — the PDF (%FILENAME%) has already been downloaded and still needs to be attached manually."
    },
    mailtoClosing: { de: "Freundliche Grüsse", fr: "Meilleures salutations", en: "Kind regards" }
  },
  ...
  dashboard: {
    ...
    // {{seconds}} is filled in server-side (lib/timings.js averageSeconds)
    // with the rolling average of recent real generations, not a fixed guess
    // — see lib/pages/indexPage.js.
    generating: {
      de: "Generiere massgeschneiderte Bewerbung … (dauert im Schnitt {{seconds}} Sekunden)",
      fr: "Génération de la candidature sur mesure … (dure en moyenne {{seconds}} secondes)",
      en: "Generating tailored application … (takes {{seconds}} seconds on average)"
    },
    generatedDone: {
    ...
    scoreNaTooltip: {
      de: "Kein Score verfügbar — entweder wurde die Bewerbung vor diesem Feature erstellt, oder die KI hat ausnahmsweise keine Einschätzung geliefert.",
      fr: "Aucun score disponible — soit la candidature a été créée avant cette fonctionnalité, soit l'IA n'a exceptionnellement fourni aucune évaluation.",
      en: "No score available — either this application was created before this feature, or the AI exceptionally didn't provide an assessment."
    },
    ...
    // {{seconds}} filled in server-side with the rolling average of recent
    // real requests, same mechanism as dashboard.generating above.
    insightsResearching: {
      de: "🔎 Recherchiere … (ca. {{seconds}}s)",
      fr: "🔎 Recherche en cours … (env. {{seconds}} s)",
      en: "🔎 Researching … (approx. {{seconds}}s)"
    },
    insightsError: {
