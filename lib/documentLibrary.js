...
function addLibraryDocument(userId, { buffer, mimetype, originalName, category, title, skillsText, lang = DEFAULT_LANG }) {
  const ext = EXT_BY_MIME[mimetype];
  if (!ext) throw new Error(t(lang, "server.invalidDocFormat"));
