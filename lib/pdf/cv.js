 ...
 */
function buildCvDocDefinition(profile, generated, { qr, photo } = {}, level = 0) {
            ...
            sectionTitle("Ausbildung", level),
            {
              stack: [
                ...
                ...(primaryEducation.note
                  ? [{ text: `Note: ${primaryEducation.note}`, fontSize: sc(level, 8.3), color: theme.accent, bold: true, margin: [0, 2, 0, 0] }]
                  : [])
              ]
            }
          ]
