 ...
 */
function buildCvDocDefinition(profile, generated, { qr, photo, lang = "de" } = {}, level = 0) {
  ...
  const sidebar = {
    width: SIDEBAR_WIDTH,
    stack: [
      sectionTitle(t(l, "pdf.strengths"), level),
      {
      ...
      ...(primaryEducation
        ? [
            spacer(level),
            sectionTitle(t(l, "pdf.education"), level),
            {
              stack: [
        ...
        : []),
      spacer(level),
      sectionTitle(t(l, "pdf.languages"), level),
      {
